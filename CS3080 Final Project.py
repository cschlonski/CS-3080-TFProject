...
past = 400  # 200 timestamps of previous data, preferably less than half of the total samples
future = 50  # predict 30 timestamp
learning_rate = 0.001
...
# Takes 5 points from the validation data set and tests the model on the date based on the past
